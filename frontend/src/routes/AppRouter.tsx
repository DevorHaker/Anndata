...
import { OfflineCentrePage } from '../pages/OfflineCentrePage';
import { SyncConflictPage } from '../pages/SyncConflictPage';
      ...
      <AuthProvider>
        <Routes>
          ...
          <Route path="/" element={<RootLayout />}>
            ...
            {/* Admin Dashboard & Sync Conflicts */}
            <Route
            ...
            {/* Phase 12 Notifications & Multilingual Communication */}
            <Route
              path="notifications"
              element={
                <ProtectedRoute>
