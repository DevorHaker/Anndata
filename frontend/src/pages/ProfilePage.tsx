...
import { User, Phone, Shield, Calendar, Key, LogOut, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-1 p-6 text-center space-y-4">
          <div className="w-20 h-20 mx-auto rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-2xl border-4 border-emerald-50">
          ...
          {user.farmerReferenceId && (
            <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl text-xs space-y-1">
              <div className="text-slate-500 font-semibold uppercase">Farmer ID</div>
              <div className="font-mono font-bold text-emerald-800 text-sm">{user.farmerReferenceId}</div>
            </div>
          )}
        </Card>
          ...
          <div>
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <dd className="font-semibold text-slate-900">{user.mobileNumber}</dd>
              </div>
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
                ...
                <dd className="font-semibold text-emerald-700">Verified &amp; Active</dd>
              </div>
            </dl>
          </div>
